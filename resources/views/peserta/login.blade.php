            ...
            <div class="nk-block toggled" id="l-login">            
                ...
                @endif
                    <div class="input-group">
                        ...
                        <div class="nk-int-st">
                            <input type="text" id="input1" name="username" class="form-control" placeholder="Nama Pengguna">
                        </div>
                    </div>
                ...
                <div class="nk-navigation nk-lg-ic">
                    <a href="{{route('peserta.registerForm')}}" data-ma-block="#l-register"><i class="notika-icon notika-plus-symbol"></i> <span>Register</span></a>                    
                </div>           
            </div>            
        </div> 
    </form> 
