            ...
            <div class="nk-block toggled" id="l-login">
                ...
                @endif
                    ...
                    <div class="input-group mg-t-15">
                        <span class="input-group-addon nk-ic-st-pro"><i class="notika-icon notika-support"></i></span>
                        <div class="nk-int-st">
                            <input type="text" id="input1" name="username" class="form-control" placeholder="Nama Pengguna (Tanpa Spasi)">
                        </div>
                    </div>
                    <div class="input-group mg-t-15">
                ...
                <div class="nk-navigation nk-lg-ic">
                    <a href="{{route('peserta.formLogin')}}" data-ma-block="#l-register"><i class="notika-icon notika-right-arrow"></i> <span>Login</span></a>                    
                </div>         
            </div>            
        </div> 
    </form> 
